      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-white text-xl font-semibold">Radian Edu Solution</span>
          </div>
        </div>
        ...
        <div className="relative z-10">
          ...
          >
            <img
              src="https://asset.kompas.com/crops/2tcslW73HH8_R2twAA7QFG238u0=/0x0:1000x667/1200x800/data/photo/2019/07/26/5d3a947414ca4.jpg"
              alt="Career"
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="font-semibold text-slate-800">TalentPath</span>
          </div>

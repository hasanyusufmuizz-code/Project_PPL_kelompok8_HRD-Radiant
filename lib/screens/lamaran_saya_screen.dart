...
class LamaranSayaScreen extends StatefulWidget {
  const LamaranSayaScreen({super.key});

  @override
  State<LamaranSayaScreen> createState() => _LamaranSayaScreenState();
}

class _LamaranSayaScreenState extends State<LamaranSayaScreen> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: Colors.grey, fontSize: Responsive.isMobile(context) ? 14 : 16),
                ),
